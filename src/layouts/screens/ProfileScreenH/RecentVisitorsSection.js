...
export default function RecentVisitorsSection() {
  const navigation = useNavigation();

  // 👉 Separate click function for Connect Now
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerRow}>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate("RecentVisitorScreen")}
        >
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          /* ⭐ Card Click → Goes to UserDetailsScreen */
          <TouchableOpacity
            activeOpacity={0.9}
            style={styles.card}
            onPress={() =>
          ...
          >
            ...
            {/* CONNECT BUTTON (SEPARATE ACTION) */}
            <TouchableOpacity
